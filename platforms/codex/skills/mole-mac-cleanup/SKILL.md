...
description: Safely use Mole (`mo`) to scan, preview, and clean macOS disk usage. Use when Codex is asked to run Mole, clean Mac caches, find large files, remove project artifacts, preview app leftovers, inspect installer files, or summarize Mole cleanup candidates before any destructive cleanup.
---
...
- Do not close apps automatically; report when Mole skips running apps such as Chrome or Codex.
