#!/usr/bin/env python3
"""Cross-platform screenshot helper for Claude Code skills."""
...
def resolve_output_path(
    ...
    if mode == "temp":
        ...
        tmp_path = tmp_dir / default_filename(fmt, prefix="claude-shot")
...
def swift_json(script: Path, extra_args: list[str] | None = None) -> dict:
    module_cache = Path(tempfile.gettempdir()) / "claude-swift-module-cache"
